...
- [2026-06-23] 当用户要求计算不同材质产品时，应该调整材料数据，不要重复使用原数据
- [2026-06-23] 当用户要求替换材质时，应该更新所有相关参数，不要只替换材质名称
- [2026-06-23] 当用户要求记录数据时，应该准确记录材料，不要混淆材料名称
- [2026-06-23] 当用户要求计算时，应该准确理解参数，不要混淆材质信息
- [2026-06-23] 当用户要求计算时，应该准确理解参数，不要混淆材质信息
- [2026-06-23] 当用户要求计算时，应该准确理解参数，不要混淆材质信息
- [2026-06-29] 当用户指出错误时，应该立即承认并纠正，不要重复错误
